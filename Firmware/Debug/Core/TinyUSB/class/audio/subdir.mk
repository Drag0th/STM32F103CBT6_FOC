...
Core/TinyUSB/class/audio/%.o Core/TinyUSB/class/audio/%.su Core/TinyUSB/class/audio/%.cyclo: ../Core/TinyUSB/class/audio/%.c Core/TinyUSB/class/audio/subdir.mk
...
clean-Core-2f-TinyUSB-2f-class-2f-audio:
	-$(RM) ./Core/TinyUSB/class/audio/audio_device.cyclo ./Core/TinyUSB/class/audio/audio_device.d ./Core/TinyUSB/class/audio/audio_device.o ./Core/TinyUSB/class/audio/audio_device.su
